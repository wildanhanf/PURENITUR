    ...
    @section('content')
        ...
        <section id="productDetail" class="mt-8 xl:mx-64 lg:mx-40 md:mx-48 sm:mx-24">
            @foreach ($data_selected_product as $data_product)
                <div
                    class="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2  xl:grid-cols-2 2xl:grid-cols-3 gap-4 mx-4 md:mx-8 mb-5">
                    <div class="relative">
                        <div class="relative">
                        ...
                        <div class="flex flex-wrap">
                            ...
                            <div class="w-full flex items-stretch">
                                <form id="submits" action="/carts" method="GET" class="">
                                    ...
                                    <button type="submit"
                                        class="w-44 md:w-[200px] bg-white rounded-lg p-3 text-primary-one font-semibold border-2 border-primary-one mr-1">Add
                                        To Chart</button>
                                </form>
                            </div>
                        </div>
                    ...
                    <div class="relative col-span-1 xl:col-span-2 2xl:col-span-1">
                        ...
                        <div class="relative">
                            <button
                                class="w-full bg-card-element-1 hover:bg-card-element-2 text-white font-semibold p-3 rounded-lg">Customization
                                Page</button>
                        </div>
                    </div>
                                ...
                                <button type="submit" style="text-align: left;" class="">
                                    ...
                                    <div class="px-4 pb-5">
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <p class="text-sm md:text-base ml-2">{{ $catalog->rating }} | Terjual
                                                {{ $catalog->sold }}</p>
                                        </div>
                                    </div>
                                </button>
