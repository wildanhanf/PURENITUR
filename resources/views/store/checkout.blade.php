                    ...
                    <form method="GET" action="/checkouts">
                        ...
                        <div>
                            ...
                            @foreach ($json as $item)
                                <p class="my-2">Quality : {{ $item->qty }}</p>
                                <p class="my-2">Name : {{ $item->model->name_product }}</p>
                                <p class="my-2">SKU : {{ $item->model->sku }}</p>
                                <p class="my-2">Price : {{ $item->model->price }}</p>
                                <img src="{{ $item->model->image }}" style=""
                                    class="h-32 w-32 my-2 border border-primary-2 rounded-md p-2">
                        ...
                        <div class="">
                            ...
                            <input id="total_price" type="hidden" name="total_price" value="{{ $total_price }}" required
                                readonly>
                        </div>

                        <div>
                            <input id="id" type="hidden" name="id" value="{{ old('id', $user->id) }}" required
                                readonly>
                            <input id="cart" type="hidden" name="cart" value="{{ $cart }}" required
                                readonly>
                        </div>
                        ...
                        <div class="">
                            ...
                            <input id="final_price" type="hidden" name="final_price" value="{{ $total_price }}" required
                                readonly>
                        </div>
                </div>
                ...
                <div class="card border border-slate-700 rounded-md p-5 mb-5">
                    <div class="">
                        ...
                        <div class="my-2">
                            ...
                            <input id="payment_method" type="hidden" name="payment_method" value="Bank Transfer BCA"
                                required readonly>
                        </div>
                    </div>
                        ...
                        <div class="my-2"><span class="head">Alamat Pengiriman</span>
                            <div class="my-2 border border-slate-700 rounded-sm">
                                <input type="text" id="shipping_address" name="shipping_address"
                                    value="{{ old('address', $user->address) }}" style=""></input>
                            </div>
                        </div>
                    </div>
