...
<section class="xl:mx-64 lg:mx-40 md:mx-48 sm:mx-24 mb-5 mx-5">
    ...
    <div class="rounded-lg md:w-2/3">
        ...
        <form method="POST" action="/payments" enctype="multipart/form-data">
            ...
            <div class="justify-between rounded-lg border bg-white p-5 shadow-md sm:flex sm:justify-start mb-5">
                <div class="sm:mt-0">
                    ...
                    <a class="mt-4 w-32 rounded-md bg-primary-1 py-1.5 font-medium text-white hover:bg-primary-2 p-2" href="{{ route('shipment') }}">Go to Shipment</a>
                    @else
