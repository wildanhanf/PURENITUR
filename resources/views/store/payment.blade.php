            ...
            <div class="rounded-lg md:w-2/3">
                <div class="justify-between mb-6 rounded-lg border bg-white p-6 shadow-md sm:flex sm:justify-start"> 
                    <div class="mt-5 sm:mt-0">
                        <h2 class="text-lg font-bold text-gray-900">TR-1234567891</h2>
                        <p class="mt-4 text-sm text-gray-700 font-medium">Lakukan pembayaran sebelum (tanggal checkout)</p>
                        <a class="inline-block mt-4 text-sm text-gray-700 font-medium hover:underline" href="https://www.google.com" target="_blank">Formulir Upload Bukti Pembayaran</a>
                    </div>
                </div>
