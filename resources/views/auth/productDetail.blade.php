...
<section id="productDetail" class="xl:mx-64 lg:mx-40 md:mx-48 sm:mx-24">
    <div class="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4 mx-4 md:mx-8 mb-5">
        <div class="relative">
            <div class="relative">
                <img src="{{asset('img/product/rak.png')}}" alt="" class="mx-auto mb-3 md:mb-4 h-[360px]">
            </div>
            <div class="relative">
        ...
        <div class="relative">
            <div class="flex flex-wrap">
                <div class="w-full flex flex-wrap md:block md:w-1/3 md:h-[360px]">
                    <img src="{{asset('img/product/rak.png')}}" alt="" class="mx-auto mb-3 md:mb-4 w-20 h-20">
                    <img src="{{asset('img/product/rak.png')}}" alt="" class="mx-auto mb-3 md:mb-4 w-20 h-20">
                    <img src="{{asset('img/product/rak.png')}}" alt="" class="mx-auto mb-3 md:mb-4 w-20 h-20">
                    <img src="{{asset('img/product/rak.png')}}" alt="" class="mx-auto md:mb-4 w-20 h-20">
                </div>
                <div class="w-full md:w-2/3 md:h-[360px] mb-4">
                        <div class="font-bold text-2xl mb-3">Detail Barang Lorem 1</div>
                        <div class="text-xs mb-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</div>
                        <div class="font-bold text-xl mb-1">Harga</div>
                        <div class="font-semibold text-xl mb-3">Rp XXX.XXX</div>
                        <div class="w-full flex flex-wrap justify-between mb-3">
                            ...
                            <div class="flex flex-wrap">
                                ...
                                <a href="">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><path fill="currentColor" d="M12 20c-4.41 0-8-3.59-8-8s3.59-8 8-8s8 3.59 8 8s-3.59 8-8 8m0-18A10 10 0 0 0 2 12a10 10 0 0 0 10 10a10 10 0 0 0 10-10A10 10 0 0 0 12 2M7 13h10v-2H7"/></svg>
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="font-regular text-base mb-3">LM10CR7</div>
                </div>
    ...
    <div class="w-full sm:w-2/3 p-3 md:mx-4">
        <span><b>Product Name:</b> Modern Wooden Wall Shelf</span><br>
        <p><b>Description:</b> The Modern Wooden Wall Shelf is a stylish and functional addition to any room in your home. Made from high-quality wood, this shelf is durable and long-lasting. The unique design features a series of interlocking wooden pieces that create a striking visual effect on your wall. The shelf is perfect for displaying decorative items, books, and other small items.</p>
        <div class="font-semibold text-lg mb-1">Price: $79.99</div>
