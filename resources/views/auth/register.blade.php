...
<form method="post" action="{{ route('register.perform') }}">
    ...
    <!-- <div class="form-group form-floating mb-3">
        <input type="radio" class="form-control" name="gender" value="{{ old('gender') }}" id="man" value="M" required="required" autofocus>
        <label for="man">Man</label><br>
        <input type="radio" class="form-control" name="gender" value="{{ old('gender') }}" id="woman" value="W" required="required" autofocus>
