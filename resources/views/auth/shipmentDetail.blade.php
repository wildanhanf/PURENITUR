...
@section('content')
    ...
    <section id="shipment" class="xl:mx-64 lg:mx-40 md:mx-48 sm:mx-24 mb-5 mx-5">
        <div class="mb-3">
            <h1 class="text-xl font-semibold">Shipment</h1>
        </div>
        @if ($shipment->count() > 0)
            @foreach ($shipment as $data_shipment)
                <div class="w-full h-full xl:w-1/2 border-2 border-slate-800 rounded-md mb-2 p-3">
                    ...
                    <div class="p-2 text-sm font-medium lg:text-base">
                    ...
                    <div class="p-2">
                        ...
                        <ol class="relative border-l border-gray-700">
                            <li class="mb-10 ml-4">
                                <div class="absolute w-3 h-3 bg-gray-700 rounded-full mt-1.5 -left-1.5 border border-white">
                                </div>
                            ...
                            @if ($data_shipment->shipment_status == 'SHIPPING')
                                <li class="mb-10 ml-4">
                                    <div
                                        class="absolute w-3 h-3 bg-gray-700 rounded-full mt-1.5 -left-1.5 border border-white">
                                    </div>
                                    ...
                                    <button type="submit" style="text-align: left;" class="">
                                        <div class="flex justify-center p-3">
                                            <img src="{{ $catalog->image }}" alt=""
                                                class="w-[100px] h-[130px] md:w-[207px] md:h-[222px]">
                                        </div>
                                        <div class="px-4 pb-5">
                                            <input type="hidden" name="id_per_product" value="{{ $catalog->id }}">
                                            <h3
                                                class="text-gray-900 font-semibold text-sm md:text-lg tracking-tigh md:mb-2">
