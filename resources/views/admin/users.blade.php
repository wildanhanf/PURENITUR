            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start">
                    ...
                    <a href="#" class="text-xl font-bold flex items-center lg:ml-2.5">
                        <img src="/img/Logo.png" class="h-8 mr-2" alt="Windster Logo">
                        <span class="self-center whitespace-nowrap">PURENITUR</span>
                    </a>
                </div>
                <div class="flex items-center">
                    ...
                    <span class="self-center whitespace-nowrap font-medium mr-8 hover:underline">Hi, Admin!</span>
                </div>
            </div>
        </div>
    </nav>
                ...
                <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
                    <div class="flex-1 px-3 bg-white divide-y space-y-1">
                        <ul class="space-y-2 pb-2">
                            <li>
                                <a href="#" class="text-base text-white font-medium rounded-lg flex items-center p-2 group bg-primary-2" aria-current="page">
                        ...
                        <div class="space-y-2 pt-2">
                            <a href="#" target="_blank" class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 group transition duration-75 flex items-center p-2">
                                <svg class="w-6 h-6 text-gray-500 flex-shrink-0 group-hover:text-gray-900 transition duration-75" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" d="M14 0h2v16h-2V0zM8 6H0v4h8v3l5-5l-5-5z"></path>
                                </svg>
