...
<section id="product" class="p-5"> 
    ...
    <div class="container product">
        ...
        <div class="">
            <!-- Product -->
            <div class="bg-white shadow-lg rounded-lg w-56 h-[350px] mx-4">
                <a href="#" class="flex justify-center">
                    <img src="{{asset('img/product/rak.png')}}" alt="" class="w-[207px] h-[222px]">
                </a>
                <div class="px-4 pb-5">
                    <h3 class="text-gray-900 font-semibold text-lg tracking-tigh mb-2">Lorem Ipsum 1</h3>
                    <p class="text-sm mb-2">Lorem ipsum sir dot amet</p>
                    <p class="text-base font-bold text-gray-900 mb-2">Rp xxx.xxx</p>
